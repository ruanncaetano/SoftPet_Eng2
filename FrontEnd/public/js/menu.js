...
<div>
  ...
  <ul id="menu-pessoa" class="ml-6 mt-2 space-y-2 hidden">
    ...
    <li><a href="../../views/viewPedro/registrarVoluntario.html" class="block hover:text-carmesim">Registrar Voluntário</a></li> <!-- aqui o link novo -->
    <li><a href="#" class="block hover:text-carmesim">Consultar</a></li>
  </ul>
</div>
      ...
      <div>
        ...
        <ul id="menu-doacao" class="ml-6 mt-2 space-y-2 hidden">
          ...
          <li><a href="#" class="block hover:text-carmesim">Consultar Doação</a></li>
        </ul>
      </div>
