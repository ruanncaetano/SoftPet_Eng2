            ...
            lista.forEach(item => {
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-4 py-2 space-x-2">
                        <button class="text-blue-600 hover:underline" onclick="editarAdotante('${item.pessoa?.cpf}')">Editar</button>
                        <button class="text-red-600 hover:underline" onclick="excluirAdotante('${item.pessoa?.cpf}')">Excluir</button>
                    </td>`;
...
function editarAdotante(cpf) {
    window.location.href = `../../views/viewWilker/alterarAdotante.html?cpf=${cpf}`;
}
